        ...
        <!--  Top nav  -->
			...
			<div class="sub-nav-box">
				<div class="sub-nav" id="nav-mod-content3">
					<ul>
						<li><a id="Make_Transfer" name="Make_Transfer"  href="maketransfer" title="Make Transfer">Make Transfer</a></li>
						<!-- 
						<li><a id="Review_Transfer" name="Review_Transfer" href="" title="Review Transfers">Review Transfers</a></li>
						 -->
						<li><a id="Add_Account" name="Add_Account" class="selected" href="addrecipient" title="Add Recipient">Add Recipient</a></li>
						<!-- 
			...
			<form id="add-accounts" name="addAccount" onsubmit="return true;" action="" method="post">
		
				<div class="data-label">
					 <label id="recipient-last-name_label" for="recipient-last-name">Last name *</label>
				</div>
				<div class="data-input">
					<input type="text" name="transfers.p2pPayeeAccount.payeeLastName" maxlength="40" value="" id="recipient-last-name"/>
				</div>
				<div class="data-label">
					 <label id="recipient-nick-name_label" for="recipient-nick-name">Nickname</label>
				</div>
				<div class="data-input">
					<input type="text" name="transfers.p2pPayeeAccount.nickName" maxlength="20" value="" id="recipient-nick-name"/>
				</div>
				<div class="data-label">
					 <label id="recipient-account-number_label" for="recipient-account-number">Account number *</label>
				</div>
				<div class="data-input">
					<input type="text" name="transfers.p2pPayeeAccount.accountNumber" value="" id="recipient-account-number"/>
				</div>
				
				<div class="button-cont">
					<a id="add-account-continue-button" class="button mrt-15" href="javascript:document.addAccount.submit();" title="Add Recipient">
							<span>Add Recipient</span>
					</a>
					<a id="add-account-cancel-button" class="button" href="https://safe.bankofamerica.com/accounts-transfer/add-accounts-cancel.go" title="Cancel">
						<span>Cancel</span></a>
				</div>
				<div class="clearboth"></div>				
