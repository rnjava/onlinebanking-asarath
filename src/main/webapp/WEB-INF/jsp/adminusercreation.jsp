...
<!-- 
		...
		<form:form method="post" action="createusersubmit" commandName="form"  onsubmit="return true;" name="createusersubmit">					
	        <table>
		     	 <tr>
		        ...
		        <tr>
			        ...
			        <tr>	
		        	<td colspan="4" align="center">
		        		<a class="button" href="javascript:document.createusersubmit.submit();" title="Add Tenant User">
							<span>Submit</span></a>
						<a class="button" 
							href="createuser?profileid=<core:out value="${form.staffProfileId}"/>&tenantid=<core:out value="${form.tenantId}"/>" 
