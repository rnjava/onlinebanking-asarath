...
db.users.drop();
db.users.save({ userId : 'sraj', password:'password', lastLoginDate:'10/12/2009', lastLoginTime:'10:24 AM ET',profileId:'3604F6E6-87E8-41C2-BF55-06C61F63CF99', tenantId:'C63A953AE20D404F8BB1F225CBC82CF0', createdDate:new Date('03/28/2009'), createdBy:'syam' });
db.users.save({ userId : 'sraj1', password:'password', lastLoginDate:'10/12/2009', lastLoginTime:'10:24 AM ET',profileId:'C3B62A95-2F72-4253-90F2-8A971B54A63C', tenantId:'CCCEDA89EC74479AB5C20AF7ACCD789D', createdDate:new Date('03/28/2009'), createdBy:'syam' });
